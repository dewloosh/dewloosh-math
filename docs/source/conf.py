...
here = os.path.dirname(__file__)
repo = os.path.join(here, '..', '..')
_version_py = os.path.join(repo, 'src', 'dewloosh', 'math', '__init__.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'dewloosh-math.tex', 'DewLoosh.Math Documentation',
     'Bence Balogh', 'manual'),
]
...
man_pages = [
    (master_doc, 'dewloosh-math', 'DewLoosh.Math Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ewloosh-math', 'DewLoosh.Math Documentation',
     author, 'ewloosh-math', 'One line description of project.',
     'Miscellaneous'),
]
